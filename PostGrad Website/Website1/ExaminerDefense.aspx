<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExaminerDefense.aspx.cs" Inherits="Website1.ExaminerDefense" %>
...
<body>
    ...
    <form id="form1" style="margin-left: 480px; margin-top:70px;"  runat="server">
        <div>
            <asp:Label ID="Label1" runat="server" Text="Choose a Defense Date"></asp:Label>
            <br />
            <br />
            <asp:TextBox ID="Date" TextMode="Date" runat="server"></asp:TextBox>
            <br />
            <br />
            <asp:Button ID="Button1" CssClass="button" runat="server" Text="View" OnClick="OnCheck" />
            <br />
