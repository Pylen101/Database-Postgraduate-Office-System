<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SupervisorProfile.aspx.cs" Inherits="Website1.SupervisorProfile" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div style="margin-left: 480px">
            ...
            <br />
            <br />
            <asp:TextBox ID="TextBox1" runat="server" placeholder="Supervisor ID" Width="355px"></asp:TextBox>
        </div>
        ...
        <p style="margin-left: 480px">
            &nbsp;</p>
        <p style="margin-left: 480px">
            <asp:Label ID="Error" style="color:red" Font-Bold runat="server" Textmode="Number" Visible="false" Text="There is no supervisor with this ID"></asp:Label>
