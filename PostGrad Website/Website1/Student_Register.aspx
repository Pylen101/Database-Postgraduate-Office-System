<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Student_Register.aspx.cs" Inherits="Website1.StdReg" %>
...
<body>
    <form id="form1" runat="server">
        <div class="container">
            ...
            <p>     
                            <asp:Label ID="address1" runat="server"  Text="Address"></asp:Label><br />

             <asp:TextBox ID="address" CssClass="TextBox" placeholder="Enter address" MaxLength="50" Width="300px" runat="server" ></asp:TextBox>
                <asp:Label ID="l6" runat="server" CssClass="labels" Text=""></asp:Label><br />
            </p>

            <p>    
                            <asp:CheckBox ID="CheckBox" runat="server" CssClass="auto-style13" Text="Please tick if Gucian"  />
